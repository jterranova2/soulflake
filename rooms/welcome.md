...
- One button, twice: **Get started**, weight 500 (not Build your Flake, not Sign in).
- Pitch in this order. Zigzag cards. Inline SVGs, not frames 80–83 JPEGs:
  1. The center — Every flake starts here. Hero hub drawing.
  2. Six cuts, not a type — Traits. Taste. Bond. Values. Conflict. Context.
  3. It grows when you tell it — lopsided on purpose.
  4. Built to be used — Know yourself. Then be known. No score. Glue, grind, repair.
...
- Commercial is a zigzag magazine brochure. Sticky flake. Words walk past.
- First pitch card is **The center**, not The hole.
- Hero flake two more +20% passes → `min(415px, 96vw)`.
- Attributed quote marquee. Know thyself first.
